//
//  TradeMoreDetailViewController.m
//  BaiFuTongApp
//
...
@implementation TradeMoreDetailViewController
...
- (void)viewDidLoad
{
    ...
    [tmpTradeTypeLabel setFont:[UIFont boldSystemFontOfSize:14]];
    ...
    [tradeTypeLabel setFont:[UIFont boldSystemFontOfSize:14]];
    ...
    [tmpTradeTimeLabel setFont:[UIFont boldSystemFontOfSize:14]];
    ...
    [tmpShiftToCdNumLabel setFont:[UIFont boldSystemFontOfSize:14]];
    ...
    [shiftToCdNumLabel setFont:[UIFont boldSystemFontOfSize:14]];
    ...
    [tmpReferToNumLabel setFont:[UIFont boldSystemFontOfSize:14]];
    ...
    [referToNumLabel setFont:[UIFont boldSystemFontOfSize:14]];
    ...
    [tmpSettleDateLabel setFont:[UIFont boldSystemFontOfSize:14]];
    ...
    [settleDateLabel setFont:[UIFont boldSystemFontOfSize:14]];
    ...
    [tmpSettleStatusLabel setFont:[UIFont boldSystemFontOfSize:14]];
    ...
    [settleStatusLabel setFont:[UIFont boldSystemFontOfSize:14]];
    ...
    [tmpTradeStatusLabel setFont:[UIFont boldSystemFontOfSize:14]];
    ...
    [tradeStatusLabel setFont:[UIFont boldSystemFontOfSize:14]];
