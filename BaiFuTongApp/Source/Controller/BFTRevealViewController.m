...
@interface BFTRevealViewController ()
...
@implementation BFTRevealViewController
...
//        }
        ...
        UIPanGestureRecognizer *_panGestureReconginzer = [[UIPanGestureRecognizer alloc] initWithTarget:self action:@selector(dragContentView:)];
